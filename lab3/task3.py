...
def main():
    ...
    ghost(surf1, 1, 0.6, 1)
    ghost(surf2, 0.8, 0.3, 1)
    ghost(surf3, 0.8, 0.3, -1)
    screen.blit(surf1, (350, 480), special_flags=pygame.BLEND_ADD)
    screen.blit(surf2, (320, 500), special_flags=pygame.BLEND_ADD)
    screen.blit(surf2, (400, 400), special_flags=pygame.BLEND_ADD)
    screen.blit(surf2, (420, 430), special_flags=pygame.BLEND_ADD)
    screen.blit(surf3, (50, 530), special_flags=pygame.BLEND_ADD)
